...
E_TABLE = [ 0x1, 0x3, 0x5, 0xF, 0x11, 0x33, 0x55, 0xFF, 0x1A, 0x2E, 0x72, 0x96, 0xA1, 0xF8, 0x13, 0x35,
...
state = [0x11111010, 0x21212525, 0x3c3c2c2c, 0x7b7b3b3b]
key = [0x11111111, 0x22222222, 0x33333333, 0x44444444]
new_state = enc_block_round(state, key)
for i in range(4):
    new_state[i] = hex(new_state[i])
print(new_state)
